// sendTemplateMessageVariable.js

const axios = require('axios');

const GRAPH_API_TOKEN = process.env.GRAPH_API_TOKEN;

const sendTemplateMessageVariable = async (recipientId, templateName, languageCode, parameters) => {
  const requestBody = {
...
module.exports = sendTemplateMessageVariable;
