const faqs = {
  "¿qué es olya y cómo funciona?": "Olya es un asistente conversacional en WhatsApp que ayuda a dejar de vapear mediante un programa personalizado de 20 días.",
  "what is olya and how does it work?": "Olya is a WhatsApp conversational assistant that helps quit vaping through a personalized 20-day program.",

  "¿cuál es el costo del servicio?": "Costo promedio de vape en México (variable) $250. Programa para dejar de vapear $199. Tu salud… no tiene precio. El plan incluye:\n- Programa completo de seguimiento por 20 días\n- Ejercicios de control de ansiedad y antojos\n- Medición de capacidad pulmonar",
  "what is the cost of the service?": "The average cost of vaping in Mexico (variable) is $250. The quit vaping program costs $199. Your health is priceless. The plan includes:\n- Full 20-day follow-up program\n- Exercises to control anxiety and cravings\n- Lung capacity measurement",

  "¿cuánto tiempo dura el programa?": "El programa dura 20 días.",
  "how long does the program last?": "The program lasts for 20 days.",
  ...
  "¿qué debo hacer si no tengo WhatsApp para usar olya?": "El servicio se proporciona a través de WhatsApp, por lo que necesitarás una cuenta activa para utilizar olya.",
  ...
  "¿cómo debo dejar de vapear al iniciar el programa?": "No necesariamente. El programa está diseñado para ayudarte a reducir y eventualmente dejar de vapear de manera gradual.",
  "should I quit vaping immediately when starting the program?": "Not necessarily. The program is designed to help you reduce and eventually quit vaping gradually.",
  ...
  "¿qué seguimiento hay disponible después de los 20 días?": "Puedes optar por programas de seguimiento y soporte adicional después de completar los 20 días iniciales.",
  "does olya offer any follow-up after the initial 20 days?": "You can opt for follow-up programs and additional support after completing the initial 20 days.",

  "¿hay algún tipo de compromiso a largo plazo?": "No, el compromiso inicial es solo por 20 días, pero puedes elegir continuar con el soporte si lo deseas.",
  "is there any long-term commitment?": "No, the initial commitment is only for 20 days, but you can choose to continue with support if desired.",
  ...
  "¿qué equipamiento hay que tener para el servicio de olya?": "No, solo necesitas tu teléfono móvil con acceso a WhatsApp.",
  "does olya's service require any additional equipment?": "No, you only need your mobile phone with access to WhatsApp.",

  "¿qué tipo de material de lectura o recursos adicionales proporciona olya?": "Sí, Olya te enviará artículos, enlaces y otros recursos útiles durante el programa.",
  ...
  "¿qué recomendaciones hay para mujeres embarazadas que usan el servicio de olya?": "Recomendamos que las mujeres embarazadas consulten a su médico antes de usar el servicio.",
  ...
  "¿cómo puede olya ayudarme a identificar los desencadenantes de mi vapeo?": "Sí, el programa te ayudará a identificar y manejar tus desencadenantes personales.",
  "can olya help me identify my vaping triggers?": "Yes, the program will help you identify and manage your personal triggers.",

  "¿qué dispositivos son compatibles con olya?": "Olya es compatible con cualquier dispositivo móvil que pueda usar WhatsApp.",
  "what devices are compatible with olya?": "Olya is compatible with any mobile device that can use WhatsApp.",
  ...
  "¿qué tipo de recompensa o incentivo ofrece olya por completar el programa?": "Olya no ofrece recompensas materiales, pero el mayor incentivo es tu propio bienestar.",
  "what type of reward or incentive does olya offer for completing the program?": "Olya does not offer material rewards, but the greatest incentive is your own well-being.",
